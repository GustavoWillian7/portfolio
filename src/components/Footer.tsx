...
const LINKEDIN_URL = "https://www.linkedin.com/in/gustavowillian7";
    ...
    <footer className="footer" id="contato">
      <div className="footer-content">
        <div className="footer-terminal-bar">
          <span className="footer-terminal-dot" />
          <span className="footer-terminal-dot" />
          <span className="footer-terminal-dot" />
          <span className="footer-terminal-title">{t("footer.title")}</span>
        </div>

        <div className="footer-body">
          <p className="footer-headline">
            <span className="prompt">&gt;_</span> {t("footer.headline")}
          </p>

          <div className="footer-links">
            <ContactLink href={GITHUB_URL} label="GitHub" icon={<GitHubIcon />} />
            <ContactLink href={LINKEDIN_URL} label="LinkedIn" icon={<LinkedInIcon />} />
            <ContactLink
              href={EMAIL_URL}
        ...
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} Gustavo Willian</span>
